  ...
  return (
    ...
    >
      ...
      <img
        src={planet1}
        alt="Distant Planet"
        className="absolute top-1/2 left-[-10vw] md:left-[5vw] -translate-y-1/2 w-[90vw] md:w-[60vw] lg:w-[45vw] max-w-[800px] opacity-10 pointer-events-none z-0 filter blur-[2px] brightness-75 mix-blend-screen"
      />
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 pointer-events-none">
        ...
        {/* Left Space - Content */}
        <div className="flex flex-col justify-center max-w-2xl pointer-events-auto mt-32 md:mt-0 order-2 md:order-1">
          <h2 
            ref={titleRef}
            className="text-5xl md:text-7xl lg:text-8xl font-black text-white mb-8 tracking-wider text-right md:text-left"
            style={{ fontFamily: '"SF Pro Rounded", ui-rounded, system-ui, sans-serif' }}
          >
            THE TRACKS
          </h2>

          <div className="space-y-6 text-gray-300 text-lg md:text-xl font-light leading-relaxed text-right md:text-left">
            <p ref={addToRefs}>
